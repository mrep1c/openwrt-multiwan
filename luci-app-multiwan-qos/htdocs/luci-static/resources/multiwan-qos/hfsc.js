...
return view.extend({
    ...
    render: function() {
        ...
        createOption('GAMEUP', _('Game Upload Override (kbps)'), _('Optional realtime upload reserve. Leave empty to calculate automatically.'), _('Auto: 1% of upload + 500, capped at 2000'), 'uinteger');
        createOption('GAMEDOWN', _('Game Download Override (kbps)'), _('Optional realtime download reserve. Leave empty to calculate automatically.'), _('Auto: 1% of download + 500, capped at 2000'), 'uinteger');
