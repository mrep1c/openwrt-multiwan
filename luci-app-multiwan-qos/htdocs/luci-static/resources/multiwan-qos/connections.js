...
var callMultiWANQoSConntrackDSCP = rpc.declare({
...
return view.extend({
    ...
    render: function (data) {
        ...
        var current_uci_limit = uci.get('multiwan-qos', 'advanced', 'MAX_CONNECTIONS') || '0';
        ...
        var table = E('table', { 'class': 'table cbi-section-table', 'id': 'multiwan_qos_connections' }, [
            E('tr', { 'class': 'tr table-titles' }, [
                ...
                E('th', { 'class': 'th' }, E('a', { 'href': '#', 'click': this.sortTable.bind(this, 'wan') }, [_('WAN'), this.createSortIndicator('wan')])),
        ...
        view.showErrorMessage = function (message) {
            ...
            table.appendChild(E('tr', { 'class': 'tr' }, [
                E('td', { 'class': 'td', 'colspan': '10', 'style': 'text-align: center; color: red; padding: 20px;' },
                    message)
            ]));
        };
        ...
        view.updateTable = function (connections) {
            try {
                ...
                connections.forEach(function (conn) {
                    ...
                    var dscpString = dscpToString(conn.dscp);
                    var wanInterface = getWanInterface(conn.dscp);
                ...
                table.appendChild(E('tr', { 'class': 'tr' }, [
                    E('td', { 'class': 'td', 'colspan': '10', 'style': 'text-align: center; color: red;' },
        ...
        var zoomSelect = E('select', {
            'class': 'zoom-select',
            'change': function (ev) {
                var table = document.getElementById('multiwan_qos_connections');
        ...
        return E('div', { 'class': 'cbi-map' }, [
            style,
            E('h2', _('MultiWAN QoS Connections')),
            limitWarning,
...
function adaptivePoll(view) {
    ...
    L.resolveDefault(callMultiWANQoSConntrackDSCP(), { connections: {} }).then(function (result) {
