    ...
    render: function () {
        return Promise.all([
            ...
            o.renderWidget = function () {
                return Promise.all([
                    fs.exec_direct('/etc/init.d/multiwan-qos', ['check_version'])
                ]).then(function (res) {
                    var output = res[0];
                            ...
                            E('button', {
                                ...
                                'click': ui.createHandlerFn(this, function () {
                                    ui.showModal(_('Change Update Channel'), [
                                        E('p', {}, _('Select the update channel for MultiWAN QoS:')),
                                        ...
                                        E('div', { 'class': 'right' }, [
                                            ...
                                            E('button', {
                                                ...
                                                'click': ui.createHandlerFn(this, function () {
                                                    ...
                                                    console.log('Executing channel change:', '/etc/init.d/multiwan-qos', updateArgs);

                                                    return fs.exec_direct('/etc/init.d/multiwan-qos', updateArgs)
