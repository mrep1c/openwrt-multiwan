...
return view.extend({
    ...
    render: function() {
        return Promise.all([
            ...
            m = new form.Map('multiwan-qos', _('MultiWAN QoS Rate Limits'),
            ...
            o = s.taboption('general', form.DynamicList, 'remote', _('Remote Devices'));
            o.datatype = 'string';
            o.placeholder = _('142.250.0.0/15, !=8.8.8.8, 2001:db8::2');
            o.rmempty = true;
            o.validate = validateTargetField;
            o.write = function(section_id, formvalue) {
                var values = formvalue.map(function(v) {
            ...
            var superRenderWidgetRemote = o.renderWidget;
            o.renderWidget = function(section_id, option_index, cfgvalue) {
                var widget = superRenderWidgetRemote.call(this, section_id, option_index, cfgvalue);
                var descr = E('div', { 'class': 'cbi-value-description' }, 
                    _('Optional. Apply limits only for connections to/from these remote IPs or sets.'));
                return E('div', {}, [widget, descr]);
            };
            ...
            o = s.taboption('general', form.Value, 'ports', _('Remote Ports'));
            o.datatype = 'string';
            o.placeholder = _('80 443 27015-27030');
            o.rmempty = true;
            o.depends('proto', 'tcp');
            o.depends('proto', 'udp');
            o.depends('proto', 'tcpudp');
            var superRenderWidgetPorts = o.renderWidget;
            o.renderWidget = function(section_id, option_index, cfgvalue) {
                var widget = superRenderWidgetPorts.call(this, section_id, option_index, cfgvalue);
                var descr = E('div', { 'class': 'cbi-value-description' }, 
                    _('Optional. Space-separated ports or port ranges. Requires TCP or UDP protocol selection.'));
                return E('div', {}, [widget, descr]);
            };
            ...
            s.modaltitle = function(section_id) {
                var name = uci.get('multiwan-qos', section_id, 'name');
                if (name) {
